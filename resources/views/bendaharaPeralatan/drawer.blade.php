    ...
    <div class="drawer drawer-mobile">
        ...
        <div class="drawer-content flex flex-col">
            <div class="p-3 lg:p-10 mt-16">
                @yield('bendaharaPeralatan-content')
            </div>
        ...
        <div class="drawer-side">
            ...
            <ul class="menu p-4 overflow-y-auto w-80 bg-base-200 text-base-content mt-16">
                ...
                <li class="my-1"><a href="{{ route('bendaharaPeralatan.dashboard') }}"
                        class="py-5 {{ Request::is('bendaharaPeralatan/dashboard') ? 'active' : null }}"><i
                            class="fa-solid fa-house"></i>Dashboard</a></li>
                <li class="my-1"><a href="{{ route('bendaharaPeralatan.tool') }}"
                        class="py-5 {{ Request::is('bendaharaPeralatan/tool') ? 'active' : null }}"><i
                            class="fa-solid fa-puzzle-piece"></i>Tools</a></li>
                <li class="mt-auto">
