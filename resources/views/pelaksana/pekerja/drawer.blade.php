    ...
    <div class="drawer drawer-mobile">
        ...
        <div class="drawer-side">
            ...
            <ul class="menu p-4 overflow-y-auto w-80 bg-base-200 text-base-content mt-16">
                ...
                <li class="my-1"><a href="{{ route('pekerja.dashboard') }}"
                        class="py-5 {{ Request::is('pekerja/dashboard') ? 'active' : null }}"><i
                            class="fa-solid fa-house"></i>Dashboard</a></li>
                <li class="my-1"><a href="{{ route('pekerja.tasks') }}"
                        class="py-5 {{ Request::is('pekerja/tasks') ? 'active' : null }}"><i
