    ...
    <div class="drawer drawer-mobile">
        ...
        <div class="drawer-side">
            ...
            <ul class="menu p-4 overflow-y-auto w-80 bg-base-200 text-base-content mt-16">
                ...
                <li class="my-1"><a href="{{ route('pimpinanProject.dashboard') }}"
                        class="py-5 {{ Request::is('pimpinanProject/dashboard') ? 'active' : null }}"><i
                            class="fa-solid fa-house"></i>Dashboard</a></li>
                <li class="my-1"><a href="{{ route('pimpinanProject.project') }}"
                        class="py-5 {{ Request::is('pimpinanProject/project') ? 'active' : null }}"><i
